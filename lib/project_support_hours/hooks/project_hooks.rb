  ...
  module Hooks
    class ProjectHooks < Redmine::Hook::ViewListener
      ...
      def view_projects_show_sidebar_bottom(context={})
        ...
        total_hours = ProjectSupportHours::Calculator.total_support_hours_for(context[:project]).to_f.round(2)
        remaining_hours = ProjectSupportHours::Calculator.total_hours_remaining_for(context[:project]).to_f.round(2)
